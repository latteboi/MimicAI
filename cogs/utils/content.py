...
HELP_CATEGORIES = {
    ...
    "6. Tools and Media": {
        "Web Grounding": (
            ...
            "This grounds replies only. Images have their own **Search grounding** in Tools -> Set Image Output."
        ),
        "URL Context": (
        ...
        "Image Generation": (
            ...
            "**Output** (`/profile manage` -> Tools -> Set Image Output) sets aspect ratio, resolution, quality, thinking level and search "
...
DEFAULT_HELP_DOCS = {
    ...
    "apis/google_gemini.txt": (
        ...
        "Capabilities: Powers standard text generation. It is the ONLY provider that natively supports Google Search Grounding and direct URL fetching, and the only one that can generate speech. Its Gemini image models draw pictures; OpenRouter offers other image models alongside them.\n"
    ...
    "apis/openrouter.txt": (
        ...
        "Limitations: OpenRouter models do NOT have native access to Google Search or URL fetching, and cannot generate speech. To use Grounding or URL Context with OpenRouter, you MUST go into `/profile manage` -> Tools -> and set Grounding/URL Context to RAG Mode.\n"
    ...
    "features/image_generation.txt": (
        ...
        "- Symptom: 'My images stopped using web research.' Fix: Images no longer follow the profile's Grounding setting. Set `/profile manage` -> Tools -> Set Image Output -> Search grounding to RAG.\n"
    ...
    "features/grounding_and_rag.txt": (
        ...
        "Images: Web Grounding applies to replies only. Image generation has its own Search grounding at `/profile manage` -> Tools -> Set Image Output: RAG for any image model, or Web search on a Gemini image model.\n"
        ...
        "- Symptom: 'My images stopped using web research.' Fix: Images no longer follow Web Grounding. Set `/profile manage` -> Tools -> Set Image Output -> Search grounding to RAG.\n"
