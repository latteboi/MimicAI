...
HELP_CATEGORIES = {
    ...
    "5. Sessions": {
        ...
        "Reaction Controls": (
            ...
            "nothing -- 🔁 or ❌ on a profile that has left, or ⏯️ or 🍿 while the session is a draft -- is taken back off.\n\n"
...
DEFAULT_HELP_DOCS = {
    ...
    "sessions/session_controls.txt": (
        ...
        "- A ⏯️ or 🍿 on a message from a profile that has left the cast carries on from whoever spoke last. A reaction that can do nothing -- 🔁 or ❌ on a profile that has left, or ⏯️ or 🍿 on a draft session -- is removed again.\n"
        "Troubleshooting / Symptoms:\n"
        ...
        "- Symptom: 'I reacted and my reaction just disappeared.' Fix: It could not do anything. The session is still a draft (press 'Start / Update Session'), nobody is seated, or the profile that wrote the message has left the cast, which 🔁 and ❌ need."
    ),
