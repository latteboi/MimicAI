...
HELP_CATEGORIES = {
    ...
    "3. Models and Parameters": {
        ...
        "Default Settings for New Profiles": (
            ...
            "and every profile you make afterwards starts there instead of on the shipped Gemini default.\n\n"
...
DEFAULT_HELP_DOCS = {
    ...
    "profiles/generating_profiles.txt": (
        ...
        "Model: The draft is written by the model a new profile of yours would run on (your `/settings` -> Defaults primary model if set, otherwise the bot's default), using your personal key, retrying once on the fallback model.\n"
