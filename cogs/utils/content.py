...
HELP_CATEGORIES = {
    ...
    "6. Tools and Media": {
        ...
        "Speech and the Director's Desk": (
            ...
            "**Voice settings** (Params -> Set Speech & Voice Settings) pick the prebuilt voice, the speech model, and temperature. Keep "
            "temperature near default; far from it produces audible artefacts.\n\n"
...
DEFAULT_HELP_DOCS = {
    ...
    "features/speech_tts.txt": (
        ...
        "Hardware: Voice Name (e.g., Aoede, Kore, Charon) and Speech Model are chosen at `/profile manage` -> Params -> Set Speech & Voice Settings. A lower temperature produces stable audio; values far from default cause audible artefacts.\n"
